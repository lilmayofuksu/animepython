...
L3_1 = L0_1
L1_1 = L1_1(L2_1, L3_1)
L1_1.defaultAlias = "Quest30005"
L2_1 = require
L3_1 = "Quest/Client/Q30005ClientConfig"
L2_1 = L2_1(L3_1)
L3_1 = L2_1.SubIDs
...
function L5_1(A0_2)
  ...
  L2_2 = A0_2.OnSubStart3000501
  L1_2["3000501"] = L2_2
  L1_2 = A0_2.subStartHandlers
  L2_2 = A0_2.OnSubStart3000502
  L1_2["3000502"] = L2_2
  L1_2 = A0_2.subStartHandlers
  L2_2 = A0_2.OnSubStart3000503
  L1_2["3000503"] = L2_2
  L1_2 = A0_2.subStartHandlers
  L2_2 = A0_2.OnSubStart3000504
  L1_2["3000504"] = L2_2
  L1_2 = A0_2.subStartHandlers
  L2_2 = A0_2.OnSubStart3000505
  L1_2["3000505"] = L2_2
end
...
function L5_1(A0_2)
  ...
  L2_2 = A0_2.OnSubFinish3000501
  L1_2["3000501"] = L2_2
  L1_2 = A0_2.subFinishHandlers
  L2_2 = A0_2.OnSubFinish3000502
  L1_2["3000502"] = L2_2
  L1_2 = A0_2.subFinishHandlers
  L2_2 = A0_2.OnSubFinish3000503
  L1_2["3000503"] = L2_2
  L1_2 = A0_2.subFinishHandlers
  L2_2 = A0_2.OnSubFinish3000504
  L1_2["3000504"] = L2_2
  L1_2 = A0_2.subFinishHandlers
  L2_2 = A0_2.OnSubFinish3000505
  L1_2["3000505"] = L2_2
end
...
function L5_1(A0_2)
  ...
  L2_2 = A0_2.OnSubFailed3000501
  L1_2["3000501"] = L2_2
  L1_2 = A0_2.subFailedHandlers
  L2_2 = A0_2.OnSubFailed3000502
  L1_2["3000502"] = L2_2
  L1_2 = A0_2.subFailedHandlers
  L2_2 = A0_2.OnSubFailed3000503
  L1_2["3000503"] = L2_2
  L1_2 = A0_2.subFailedHandlers
  L2_2 = A0_2.OnSubFailed3000504
  L1_2["3000504"] = L2_2
  L1_2 = A0_2.subFailedHandlers
  L2_2 = A0_2.OnSubFailed3000505
  L1_2["3000505"] = L2_2
end
...
L1_1.OnSubFinish3000502 = L5_1
function L5_1(A0_2)
  local L1_2, L2_2
  L1_2 = print
  L2_2 = "********Quest30005 Start"
  L1_2(L2_2)
end
L1_1.Start = L5_1
function L5_1(A0_2)
