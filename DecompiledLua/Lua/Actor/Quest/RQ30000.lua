...
L3_1 = L0_1
L1_1 = L1_1(L2_1, L3_1)
L1_1.defaultAlias = "Quest30000"
L2_1 = require
L3_1 = "Quest/Client/Q30000ClientConfig"
L2_1 = L2_1(L3_1)
L3_1 = L2_1.SubIDs
function L4_1(A0_2)
  local L1_2, L2_2
  ...
  L2_2 = A0_2.OnSubStart3000001
  L1_2["3000001"] = L2_2
  L1_2 = A0_2.subStartHandlers
  L2_2 = A0_2.OnSubStart3000002
  L1_2["3000002"] = L2_2
  L1_2 = A0_2.subStartHandlers
  L2_2 = A0_2.OnSubStart3000003
  L1_2["3000003"] = L2_2
  L1_2 = A0_2.subStartHandlers
  L2_2 = A0_2.OnSubStart3000004
  L1_2["3000004"] = L2_2
  L1_2 = A0_2.subStartHandlers
  L2_2 = A0_2.OnSubStart3000005
  L1_2["3000005"] = L2_2
end
...
function L4_1(A0_2)
  ...
  L2_2 = A0_2.OnSubFinish3000001
  L1_2["3000001"] = L2_2
  L1_2 = A0_2.subFinishHandlers
  L2_2 = A0_2.OnSubFinish3000002
  L1_2["3000002"] = L2_2
  L1_2 = A0_2.subFinishHandlers
  L2_2 = A0_2.OnSubFinish3000003
  L1_2["3000003"] = L2_2
  L1_2 = A0_2.subFinishHandlers
  L2_2 = A0_2.OnSubFinish3000004
  L1_2["3000004"] = L2_2
  L1_2 = A0_2.subFinishHandlers
  L2_2 = A0_2.OnSubFinish3000005
  L1_2["3000005"] = L2_2
end
...
function L4_1(A0_2)
  ...
  L2_2 = A0_2.OnSubFailed3000001
  L1_2["3000001"] = L2_2
  L1_2 = A0_2.subFailedHandlers
  L2_2 = A0_2.OnSubFailed3000002
  L1_2["3000002"] = L2_2
  L1_2 = A0_2.subFailedHandlers
  L2_2 = A0_2.OnSubFailed3000003
  L1_2["3000003"] = L2_2
  L1_2 = A0_2.subFailedHandlers
  L2_2 = A0_2.OnSubFailed3000004
  L1_2["3000004"] = L2_2
  L1_2 = A0_2.subFailedHandlers
  L2_2 = A0_2.OnSubFailed3000005
  L1_2["3000005"] = L2_2
end
...
function L4_1(A0_2, A1_2)
  ...
  L6_2 = tonumber
  L8_2 = A0_2
  L7_2 = A0_2.GetRandomFactorValue
  L9_2 = "{QuestMonsterID}"
  ...
  L7_2 = tonumber
  L9_2 = A0_2
  L8_2 = A0_2.GetRandomFactorValue
  L10_2 = "{QuestMonsterNum}"
  ...
  L12_2 = A0_2
  L11_2 = A0_2.CreateQuestNpcWithPos
  L13_2 = A1_2
  L14_2 = L2_2
  L15_2 = 0
  L16_2 = L10_2.pos
  ...
  L14_2 = 60
  L15_2 = A0_2.QuestDestroy
  L12_2(L13_2, L14_2, L15_2)
end
L1_1.OnSubStart3000001 = L4_1
function L4_1(A0_2, A1_2)
  local L2_2, L3_2, L4_2, L5_2, L6_2
  L3_2 = A0_2
  L2_2 = A0_2.GetRandomNpcAlias
  L5_2 = A0_2
  ...
  L4_2(L5_2, L6_2)
  L4_2 = print
  L5_2 = "********30000***DestroyUncalled****"
  L4_2(L5_2)
end
L1_1.OnSubStart3000002 = L4_1
function L4_1(A0_2, A1_2)
  local L2_2, L3_2, L4_2
  L2_2 = print
  L3_2 = "********30000***DestroyNPC****"
  L2_2(L3_2)
  L3_2 = A0_2
...
L1_1.OnSubFailed3000004 = L4_1
function L4_1(A0_2)
  local L1_2, L2_2
  L1_2 = print
  L2_2 = "********Quest30000 Start"
  L1_2(L2_2)
end
L1_1.Start = L4_1
function L4_1(A0_2)
